...
#Objective: The objective for this brief report is to understand and analyze male employment patterns. In particular, there should be a focus on trends and patterns in the participation of men in Health, Education, Administration and Literacy (HEAL) roles. For this brief, it's important to identify if there are possible points of intervention to encourage men to enter and stay in these fields. 

#Data Source: State of California Workforce — Open Data Portal
#Data Link: https://data.ca.gov/dataset/calhr-civil-rights-data-for-gare-capital-cohort-2019
